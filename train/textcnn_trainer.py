...
def train(config_path: str | Path = "params/params_textcnn.yaml"):
    ...
    best_model_path = output_dir / "textcnn.pt"
    ...
    for epoch in range(1, config.epochs + 1):
        ...
        val_loss, val_acc, val_recall, val_f1, val_micro_f1 = evaluate(model, val_loader, device, model_name="textcnn")
    ...
    test_loss, test_acc, test_recall, test_f1, test_micro_f1 = evaluate(model, test_loader, device, model_name="textcnn", plt_confusion_matrix=True, labels=list(label2id.keys()))
